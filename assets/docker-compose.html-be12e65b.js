import{_ as s,o as n,c as e,a}from"./app-fdb0ca41.js";const i={},l=a(`<h1 id="docker-compose" tabindex="-1"><a class="header-anchor" href="#docker-compose" aria-hidden="true">#</a> Docker Compose</h1><h2 id="一、安装docker-compose" tabindex="-1"><a class="header-anchor" href="#一、安装docker-compose" aria-hidden="true">#</a> 一、安装Docker Compose</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Compose目前已经完全支持Linux、Mac OS和Windows，在我们安装Compose之前，需要先安装Docker。下面我 们以编译好的二进制包方式安装在Linux系统中。</span>
