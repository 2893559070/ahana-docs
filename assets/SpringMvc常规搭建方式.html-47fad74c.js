import{_ as n,p as s,q as a,a1 as t}from"./framework-5866ffd3.js";const p={},e=t(`<h1 id="常规搭建方式" tabindex="-1"><a class="header-anchor" href="#常规搭建方式" aria-hidden="true">#</a> 常规搭建方式</h1><h2 id="常规搭建方式-1" tabindex="-1"><a class="header-anchor" href="#常规搭建方式-1" aria-hidden="true">#</a> 常规搭建方式</h2><h3 id="文件层级" tabindex="-1"><a class="header-anchor" href="#文件层级" aria-hidden="true">#</a> 文件层级</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>    - src
        - main
