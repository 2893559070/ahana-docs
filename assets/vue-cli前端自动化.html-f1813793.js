import{_ as n,o as s,c as a,a as e}from"./app-9d6e6088.js";const p={},t=e(`<h1 id="vue-cli前端自动化" tabindex="-1"><a class="header-anchor" href="#vue-cli前端自动化" aria-hidden="true">#</a> vue-cli前端自动化</h1><h2 id="环境配置" tabindex="-1"><a class="header-anchor" href="#环境配置" aria-hidden="true">#</a> 环境配置</h2><p>可以配置npm下载源</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>  - 根目录
    - .npmrc
