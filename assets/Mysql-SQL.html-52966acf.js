import{_ as n,o as a,c as d,b as e,d as s,a as i}from"./app-9d6e6088.js";const r={},c=i(`<h1 id="mysql-sql" tabindex="-1"><a class="header-anchor" href="#mysql-sql" aria-hidden="true">#</a> Mysql-SQL</h1><h2 id="dml" tabindex="-1"><a class="header-anchor" href="#dml" aria-hidden="true">#</a> DML</h2><h3 id="update、insert、delete-增删改查" tabindex="-1"><a class="header-anchor" href="#update、insert、delete-增删改查" aria-hidden="true">#</a> (update、insert、delete) 增删改查</h3><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>-- update
