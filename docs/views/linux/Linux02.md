...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576640085716.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576640392259.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576648168657.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576648319770.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576648420787.png')" alt="foo">
...
下面是三种模式的简单分析图：
  ...
  <img :src="$withBase('/linux/assets/1576653460302.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576655123201.png')" alt="foo">
...
上图可以表现为以下形式，如下图
  ...
  <img :src="$withBase('/linux/assets/1576663442969.png')" alt="foo">

执行效果如下图

  <img :src="$withBase('/linux/assets/1576655181144.png')" alt="foo">
...
如果里面的文本很多，要使用【A】进入编辑模式，即在行末添加文本
  ...
  <img :src="$withBase('/linux/assets/1576655270283.png')" alt="foo">
...
进入末行模式—》按符号： 鼠标跑到屏幕的最后一行，执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576655879564.png')" alt="foo">

然后按小写的**:wq 正常保存退出**

  <img :src="$withBase('/linux/assets/1576655592207.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576657358085.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576657409815.png')" alt="foo">
...
我们还是使用上面的txtfile.txt文件，如下图
  ...
  <img :src="$withBase('/linux/assets/1576664862829.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576664910366.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576665113269.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576666861596.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576666928266.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577095621215.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577095998308.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577096070670.png')" alt="foo">
...
原始文件内容如下
  ...
  <img :src="$withBase('/linux/assets/1576667678964.png')" alt="foo">

最后3行内容如下

  <img :src="$withBase('/linux/assets/1576667701796.png')" alt="foo">
...
执行效果如下：
  ...
  <img :src="$withBase('/linux/assets/1576667811261.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576719306123.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576719057889.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576719098586.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576720622842.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576659165723.png')" alt="foo">
...
- 下次再使用 vim 编辑文件时, 会看到以下屏幕信息,
  ...
  <img :src="$withBase('/linux/assets/1576658330514.png')" alt="foo">

解决方案：

将后缀名为.swp的文件删除即可恢复

  <img :src="$withBase('/linux/assets/1576658480811.png')" alt="foo">
...
**1) 上 下 左 右**
  ...
  <img :src="$withBase('/linux/assets/1558278451153.png')" alt="foo">
...
**6.3 重定向 `>`(覆盖) 和 `>>` (追加)**
  ...
  <img :src="$withBase('/linux/assets/1558435686066.png')" alt="foo">
...
执行结果如下（czbk-txt.txt文件如果没有会自动创建）
  ...
  <img :src="$withBase('/linux/assets/1576721910460.png')" alt="foo">
...
执行结果如下
  ...
  <img :src="$withBase('/linux/assets/1576721980097.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576722167942.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577178031588.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577178523300.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577178563336.png')" alt="foo">

  <img :src="$withBase('/linux/assets/1577179227699.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577180402362.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577180698120.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577180583110.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577180635136.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577180660454.png')" alt="foo">
...
- 在Linux**文件名** 和 **内容** 是两个文件, 分开的!  <img :src="$withBase('/linux/assets/1558439106175.png')" alt="foo">

- 创建软链接的原理, 如下  <img :src="$withBase('/linux/assets/1558439158250.png')" alt="foo">
...
如下图
  ...
  <img :src="$withBase('/linux/assets/1576723058556.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576828863833.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576829221486.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576829352063.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576829929308.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577409765115.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577410272633.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576736152636.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576736179025.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576736286406.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576738711718.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576726937758.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576727107465.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576734505587.png')" alt="foo">
...
解压后的文件如下
  ...
  <img :src="$withBase('/linux/assets/1576735062585.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576736751949.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576736844251.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576737168412.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576737722160.png')" alt="foo">

 查看解压后的文件，如下图

  <img :src="$withBase('/linux/assets/1576737744650.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576742060052.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576744907366.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576749039798.png')" alt="foo">

  <img :src="$withBase('/linux/assets/1576749055869.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576748850255.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576748937884.png')" alt="foo">
...
执行效果如下，配置ip地址：
  ...
  <img :src="$withBase('/linux/assets/1576749864267.png')" alt="foo">

查看ip，如下图

  <img :src="$withBase('/linux/assets/1576749896757.png')" alt="foo">

配置ip地址和子网掩码，执行效果如下图

  <img :src="$withBase('/linux/assets/1576749957171.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576750258293.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576750967595.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576751379320.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576751502980.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576827840642.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576828112552.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576751996364.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576752158168.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576752596414.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576752719226.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576752819456.png')" alt="foo">
...
进入【虚拟机】--【设置】
  ...
  <img :src="$withBase('/linux/assets/1576805605263.png')" alt="foo">

设置CD/DVD的内容，我们这里使用的是F:\CentOS-7-x86_64-DVD-1810.iso

  <img :src="$withBase('/linux/assets/1576805634085.png')" alt="foo">

查看F:\CentOS-7-x86_64-DVD-1810.iso；里面的内容

  <img :src="$withBase('/linux/assets/1576805690039.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576807195774.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576807395970.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576807774194.png')" alt="foo">
...
**yum原理**
  ...
  <img :src="$withBase('/linux/assets/1576833281476.png')" alt="foo">
...
提示我们【需要管理员权限】
  ...
  <img :src="$withBase('/linux/assets/1576554600128.png')" alt="foo">

  <img :src="$withBase('/linux/assets/1576554617660.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576832663328.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576832810922.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576832843434.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576832953119.png')" alt="foo">
...
目前，yum默认使用的是CentOS的yum源，如下
  ...
  <img :src="$withBase('/linux/assets/1576834523252.png')" alt="foo">

  <img :src="$withBase('/linux/assets/1576834556997.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576834799803.png')" alt="foo">

  <img :src="$withBase('/linux/assets/1576834824250.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576834936907.png')" alt="foo">
...
> 上面的url中要卸载Centos-7.repo；而不是Centos-6.repo
 ...
 执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1576837935001.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576838137800.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576838150825.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576836672011.png')" alt="foo">
...
**rpm包**
  ...
  <img :src="$withBase('/linux/assets/1577255859260.png')" alt="foo">
...
[Shell](https://www.leiue.com/tags/shell) [脚本](https://www.leiue.com/tags/脚本)（[Shell Script](https://www.leiue.com/tags/shell-script)）又称 Shell 命令稿、程序化脚本，是一种计算机程序使用的文本文件，内容由一连串的 shell 命令组成，经由 Unix Shell 直译其内容后运作
  ...
  <img :src="$withBase('/linux/assets/1576838959401.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577068054836.png')" alt="foo">
...
**2、编写并保存**
  ...
  <img :src="$withBase('/linux/assets/1576839380199.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576839550390.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576839765609.png')" alt="foo">
...
执行效果如下：
  ...
  <img :src="$withBase('/linux/assets/1576839880567.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577175492599.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1577175655898.png')" alt="foo">
...
```
 ...
 执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1577175714493.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1577175804257.png')" alt="foo">
...
输出结果为：
  ...
  <img :src="$withBase('/linux/assets/1577175850350.png')" alt="foo">
...
输出结果为：
  ...
  <img :src="$withBase('/linux/assets/1577175902317.png')" alt="foo">
...
输出结果：4.表示长度为4
  ...
  <img :src="$withBase('/linux/assets/1577175975730.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577176031872.png')" alt="foo">
...
如下
  ...
  <img :src="$withBase('/linux/assets/1577067300329.png')" alt="foo">

 执行效果如下：

  <img :src="$withBase('/linux/assets/1577067402285.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577068429739.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577152161538.png')" alt="foo">
...
```
 ...
 执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577158474734.png')" alt="foo">
...
执行效果如下：
  ...
  <img :src="$withBase('/linux/assets/1577169772803.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577170810671.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577171478166.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577174880068.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577175009088.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577152946471.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577153230698.png')" alt="foo">
...
<img :src="$withBase('/linux/assets/1577153468616.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1577153795748.png')" alt="foo">
...
执行效果如下图
  ...
  <img :src="$withBase('/linux/assets/1577159360606.png')" alt="foo">
