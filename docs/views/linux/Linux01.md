...
```
  ...
  <img :src="$withBase('/linux/assets/1576042675759.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576054831537.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576143218612.png')" alt="foo">
...
```
  ...
  <img :src="$withBase('/linux/assets/1576032746450.png')" alt="foo">
...
执行效果如下  <img :src="$withBase('/linux/assets/1576589467908.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576589641341.png')" alt="foo">
...
执行效果（erlang新建文件）
  ...
  <img :src="$withBase('/linux/assets/1576589820604.png')" alt="foo">

执行效果（golanglang新建文件）

  <img :src="$withBase('/linux/assets/1576589856968.png')" alt="foo">

查看所有文件

  <img :src="$withBase('/linux/assets/1576589903617.png')" alt="foo">
...
执行效果如下
  ...
  <img :src="$withBase('/linux/assets/1576590031376.png')" alt="foo">
