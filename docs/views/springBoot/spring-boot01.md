...
<img :src="$withBase('/springboot/img/1571298554472.png')" alt="foo">

<img :src="$withBase('/springboot/img/1571298554472.png')" alt="foo">

<img :src="$withBase('/springboot/img/1571298632944.png')" alt="foo">
...
<img :src="$withBase('/springboot/img/1571299932949.png')" alt="foo">
