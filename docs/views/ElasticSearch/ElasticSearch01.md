...
### 2.1-基于数据库查询的问题
  ...
  <img :src="$withBase('/ElasticSearch/img/1580888245982.png')" alt="foo">
...
将一段文本按照一定的规则，拆分为不同的词条（term）
  ...
  <img :src="$withBase('/ElasticSearch/img/1580887683510.png')" alt="foo">

  <img :src="$withBase('/ElasticSearch/img/1580887667417.png')" alt="foo">
...
Es使用倒排索引，对title 进行分词
  ...
  <img :src="$withBase('/ElasticSearch/img/1581143412491.png')" alt="foo">
...
2. 使用“华为手机”作为关键字查询
   ...
   手机：1,2,3
     ...
     <img :src="$withBase('/ElasticSearch/img/1581143489911.png')" alt="foo">

### **2.4-ES概念详解**

•ElasticSearch是一个基于Lucene的搜索服务器

  <img :src="$withBase('/ElasticSearch/img/1580887955947.png')" alt="foo">
...
### 3.1-ES安装
 ...
 [参见ElasticSearch-ES安装.md](./Elasticsearch%20%E5%AE%89%E8%A3%85.md)
...
DELETE：用来删除资源
  ...
  <img :src="$withBase('/ElasticSearch/img/1580888675397.png')" alt="foo">
...
- 数值
  <img :src="$withBase('/ElasticSearch/img/01.png')" alt="foo">
- 布尔：boolean
- 二进制：binary
- 范围类型
...
[ik分词器安装](./ik%E5%88%86%E8%AF%8D%E5%99%A8%E5%AE%89%E8%A3%85.md)
...
```
  ...
  <img :src="$withBase('/ElasticSearch/img/1580879388109.png')" alt="foo">
...
```java
@Configuration
// 读取yml配置文件 指定读取前缀 prefix="elasticsearch"
...
/**
    ...
    public void addIndex() throws IOException {
       //1.使用client获取操作索引对象
        ...
        //2.具体操作获取返回值
        //2.1 设置索引名称
        CreateIndexRequest createIndexRequest=new CreateIndexRequest("ahana");
...
```java
 /**
    ...
    public void deleteIndex() throws IOException {
         IndicesClient indices = client.indices();
        DeleteIndexRequest deleteRequest=new DeleteIndexRequest("ahana");
...
```java
 /**
    ...
    public void existIndex() throws IOException {
        ...
        GetIndexRequest getIndexRequest=new GetIndexRequest("ahana");
