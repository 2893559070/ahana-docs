import{_ as n,o as s,c as a,a as p}from"./app-fdb0ca41.js";const t={},e=p(`<h1 id="plugin插件" tabindex="-1"><a class="header-anchor" href="#plugin插件" aria-hidden="true">#</a> plugin插件</h1><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 创建 plugin 插件</span>
