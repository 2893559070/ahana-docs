import{_ as e,o as t,c as p,b as n,d as o,a as s}from"./app-676abf65.js";const i={},l=s(`<h1 id="ik分词器安装" tabindex="-1"><a class="header-anchor" href="#ik分词器安装" aria-hidden="true">#</a> IK分词器安装</h1><h3 id="_1、环境准备" tabindex="-1"><a class="header-anchor" href="#_1、环境准备" aria-hidden="true">#</a> 1、环境准备</h3><p>Elasticsearch 要使用 ik，就要先构建 ik 的 jar包，这里要用到 maven 包管理工具，而 maven 需要java 环境，而 Elasticsearch 内置了jdk， 所以可以将JAVA_HOME设置为Elasticsearch 内置的jdk</p><p><strong>1）设置JAVA_HOME</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/profile
