import{_ as n,o as s,c as a,a as t}from"./app-fdb0ca41.js";const e={},p=t(`<h1 id="骚操作" tabindex="-1"><a class="header-anchor" href="#骚操作" aria-hidden="true">#</a> 骚操作</h1><h2 id="vue-util-definereactive" tabindex="-1"><a class="header-anchor" href="#vue-util-definereactive" aria-hidden="true">#</a> Vue.util.defineReactive</h2><p>Vue.util.defineReactive，它就是Vue监听current变量重要执行者</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>  ar test<span class="token operator">=</span><span class="token punctuation">{</span>
