...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),b={href:"https://dev.mysql.com/downloads/repo/yum/",target:"_blank",rel:"noopener noreferrer"},h=["src"],k=["src"],g=e(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://dev.mysql.com/get/mysql80-community-release-el7-4.noarch.rpm <span class="token comment">## 复制下来的链接</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,1),y=["src"],f=e(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> mysql80-community-release-el7-4.noarch.rpm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),w=["src"],B=e(`<p><strong>6. 初始化</strong> MySQL服务器初始化（从MySQL 5.7开始）</p><p>在 MySQL 服务器初始启动时，如果服务器的数据目录为空，则会发生以下情况：</p><ul><li>MySQL 服务器已初始化。</li><li>在数据目录中生成SSL证书和密钥文件。</li><li>安装并启用该 validate_password 插件。</li><li>将创建一个超级用户 帐户’root’@‘localhost’。并会设置超级用户的密码，将其存储在错误日志文件/var/log/mysqld.log中。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">grep</span> <span class="token string">&#39;temporary password&#39;</span> /var/log/mysqld.log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,4),S=["src"],M=e(`<p><strong>7. 连接mysql修改默认密码</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>mysql <span class="token parameter variable">-uroot</span> -p<span class="token string">&#39;goUaahghs8?r&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="rpm-安装" tabindex="-1"><a class="header-anchor" href="#rpm-安装" aria-hidden="true">#</a> rpm 安装</h2>`,8),L=["src"],Q=["src"],x=["src"],$=["src"],E=s("h2",{id:"修改密码规则",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#修改密码规则","aria-hidden":"true"},"#"),a(" 修改密码规则")],-1),O=["src"],R=s("h2",{id:"创建用户用于远程访问",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#创建用户用于远程访问","aria-hidden":"true"},"#"),a(" 创建用户用于远程访问")],-1),A=["src"];function I(n,z){const l=r("ExternalLinkIcon");return o(),p("div",null,[d,m,s("p",null,[s("a",u,[a("downloads.mysql"),i(l)])]),v,s("ul",null,[s("li",null,[s("p",null,[a("使用官方yum仓库 "),s("a",b,[a("官方yum仓库"),i(l)])]),s("img",{src:n.$withBase("/mysql/01.png"),alt:"foo"},null,8,h),s("img",{src:n.$withBase("/mysql/02.png"),alt:"foo"},null,8,k)])]),g,a(),s("img",{src:n.$withBase("/mysql/03.png"),alt:"foo"},null,8,y),f,a(),s("img",{src:n.$withBase("/mysql/04.png"),alt:"foo"},null,8,q),_,a(),s("img",{src:n.$withBase("/mysql/05.png"),alt:"foo"},null,8,w),B,a(),s("img",{src:n.$withBase("/mysql/06.png"),alt:"foo"},null,8,S),M,s("img",{src:n.$withBase("/mysql/mysqlAz01.png"),alt:"foo"},null,8,L),s("img",{src:n.$withBase("/mysql/mysqlAz02.png"),alt:"foo"},null,8,Q),s("img",{src:n.$withBase("/mysql/mysqlAz03.png"),alt:"foo"},null,8,x),s("img",{src:n.$withBase("/mysql/mysqlAz04.png"),alt:"foo"},null,8,$),E,s("img",{src:n.$withBase("/mysql/mysqlAz05.png"),alt:"foo"},null,8,O),R,s("img",{src:n.$withBase("/mysql/mysqlAz06.png"),alt:"foo"},null,8,A)])}const N=t(c,[["render",I],["__file","安装mysql.html.vue"]]);export{N as default};
